...
local aa = {
        ...
        function o.New(p, q, r, s)
            ...
            x.ContainerFrame =
                ...
                "ScrollingFrame",
                {
                    ...
                    ScrollBarImageColor3 = Color3.fromRGB(250, 250, 250),
            ...
            local D, E =
                s(
                    "Frame",
                    {
                        ...
                        BackgroundColor3 = Color3.fromRGB(76, 194, 250),
                ...
                function()
                    ...
                    local J, K =
                        function()
                            ...
                            return {R = math.floor(J.r * 250), G = math.floor(J.g * 250), B = math.floor(J.b * 250)}
                        end,
                        s(
                            "ImageLabel",
                            {
                        ...
                        function(ad)
                            if ad then
                                ...
                                if af and typeof(ag) == "Color3" then
                                    if tonumber(W.Input.Text) <= 250 then
                    ...
                    p.AddSignal(
                        ...
                        function(ad)
                            if ad then
                                ...
                                if af and typeof(ag) == "Color3" then
                                    if tonumber(X.Input.Text) <= 250 then
                                        D, E, F = Color3.toHSV(ag)
                                    end
                                end
                            end
                    ...
                    p.AddSignal(
                        ...
                        function(ad)
                            if ad then
                                ...
                                if af and typeof(ag) == "Color3" then
                                    if tonumber(Y.Input.Text) <= 250 then
                                        D, E, F = Color3.toHSV(ag)
                                    end
                                end
                            end
        ...
        function g.New(h, i, j)
            ...
            local t =
                ...
                "ScrollingFrame",
                {
                    ...
                    BackgroundTransparency = 1,
                    BottomImage = "rbxassetid://103429419319364",
                    MidImage = "rbxassetid://103429419319364",
                    TopImage = "rbxassetid://103429419319364",
                    ScrollBarImageColor3 = Color3.fromRGB(250, 250, 250),
                    ScrollBarImageTransparency = 0.95,
    ...
    [28] = function()
        ...
        return {
            assets = {
                ...
                ["lucide-leaf"] = "rbxassetid://10723425039",
    ...
    [52] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(250, 250, 250), Color3.fromRGB(250, 250, 250)),
            AcrylicNoise = 0.96,
            ...
            ToggleToggled = Color3.fromRGB(250, 250, 250),
